...
Require the package with composer using the following command:
    ...
    composer require patrickmwangi017/laravel-calendar
...
Alternatively, you can use an existing class and have it implement `Patrickmwangi017\LaravelCalendar\Event`. An example of an Eloquent model that implements the `Event` interface:

```php
class EventModel extends Eloquent implements \Patrickmwangi017\LaravelCalendar\Event
{
...
If you wish for your existing class to have event IDs, implement `\Patrickmwangi017\LaravelCalendar\IdentifiableEvent` instead. This interface extends `\Patrickmwangi017\LaravelCalendar\Event` to add a `getId()` method:

```php
class EventModel extends Eloquent implements \Patrickmwangi017\LaravelCalendar\IdentifiableEvent
{
...
```php
<?php
class CalendarEvent extends \Illuminate\Database\Eloquent\Model implements \Patrickmwangi017\LaravelCalendar\Event
{
    //...
